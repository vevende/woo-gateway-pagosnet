...
$settings = array(
	'enabled' => array(
		...
		'type'    => 'checkbox',
		'label'   => __( 'Habilitar PagosNet', 'woocommerce' ),
		'default' => 'yes',
	),
	...
	'description' => array(
		...
		'default'     => __( 'Paga via PagosNet.', 'woocommerce' ),
	),

	'identity_token' => array(
		'title'       => __( 'Llave de Identificación', 'woocommerce' ),
		'type'        => 'text',
		'description' => __( 'Ingrese su llave PagosNet de Identificación, esta se usara para identificar al comercio dentro de la pasarela de pagos. ', 'woocommerce' ),
		'default'     => '',
		'desc_tip'    => true,
	),
	...
	'encrypt_key' => array(
		...
		'type'        => 'text',
		'description' => __( 'Esta se usara para encriptar los parámetros antes de re direccionar a la pasarela de pagos PagosNet así como también desencriptar la respuestas de esta misma.', 'woocommerce' ),
		'default'     => '',
		'desc_tip'    => true,
		'placeholder' => '',
	),
	...
	'confirmation_message' => array(
		...
		'type'        => 'text',
		'description' => __( 'Este mensaje será enviado al cliente cuando el pago se haya realizado de manera exitosa.', 'woocommerce' ),
...
if ( get_woocommerce_currency() != "BOB" ) {
	$settings['rate_convert'] = array(
		...
		'type'        => 'text',
		'description' => __( 'Tipo de cambio entre la moneda del sitio (' . get_woocommerce_currency() . ') y PagosNet.', 'woocommerce' ),
		'default'     => '1',
		'desc_tip'    => true,
	);
}
